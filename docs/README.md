 ...
 **링크**: 모든 문서가 표준 마크다운 링크 `[텍스트](경로.md)` 사용 (GitHub Wiki `[[page]]` 구문 제거됨)
 **다이어그램**: [Mermaid](https://mermaid.js.org/) 구문 사용 — XWiki에서는 [Diagram Macro](https://extensions.xwiki.org/xwiki/bin/view/Extension/Diagram%20Macro/) 또는 [Mermaid Macro](https://extensions.xwiki.org/xwiki/bin/view/Extension/Mermaid%20Macro/) 확장 설치 필요
 **테이블**: 표준 마크다운 테이블 사용 (XWiki 자동 변환 지원)
 **코드 블록**: ` ``` ` 펜스 코드 블록 사용 (XWiki 지원)
---
