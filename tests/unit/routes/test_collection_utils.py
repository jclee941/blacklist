...
class TestCallCollectorApi:
    @patch("core.routes.api.collection.utils.COLLECTOR_SERVICE_URL", "http://test:8545")
    ...
    def test_get_success_returns_json(self, mock_get):
        ...
        mock_get.assert_called_once_with("http://test:8545/health", timeout=10)
    ...
    def test_post_success_with_data(self, mock_post):
        ...
        mock_post.assert_called_once_with("http://test:8545/collect", json=payload, timeout=30)
